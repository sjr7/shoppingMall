 ...
 */
function login() {
    return location.href = "http://localhost:8090/user/login";
}
function regist() {
    return location.href = "http://localhost:8090/user/register";
}
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function () {
    ...
    })) : f ? "1" === f && (location.href = "../../../webapp") : e.test(b) && !d.test(b) ? (createCookie("goToMobile", "1", 10, "/;domain=www.jd.com"), location.href = "../../../webapp") : createCookie("goToMobile", "0", 10, "/;domain=www.jd.com")
};
var CookieUtil = {};
