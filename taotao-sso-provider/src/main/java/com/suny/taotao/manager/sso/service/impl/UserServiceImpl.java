package com.suny.taotao.manager.sso.service.impl;

import com.suny.taotao.common.pojo.TaotaoResult;
import com.suny.taotao.common.utils.JsonUtils;
import com.suny.taotao.manager.mapper.TbUserMapper;
import com.suny.taotao.manager.pojo.TbUser;
import com.suny.taotao.manager.pojo.TbUserExample;
import com.suny.taotao.manager.sso.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public TaotaoResult login(String username, String password) {
        ...
        stringRedisTemplate.opsForValue().set(USER_SESSION + ":" + token, JsonUtils.objectToJson(user));
        // 设置key的过期时间,模拟Session的过期时间,一般为半个小时
        stringRedisTemplate.expire(USER_SESSION + ":" + token, SESSION_EXPIRE, TimeUnit.SECONDS);
    ...
    public TaotaoResult getUserByToken(String token) {
        // 根据token查询redis
        String json = stringRedisTemplate.opsForValue().get(USER_SESSION + ":" + token);
